		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employees",
									"targetURL": "#mikelazquetamikelazqueta-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mikelazquetamikelazqueta-display": {
								"semanticObject": "mikelazquetamikelazqueta",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mikelazqueta.mikelazqueta",
									"url": sap.ui.require.toUrl("mikelazqueta/mikelazqueta")
								}
							}
						}
					}
