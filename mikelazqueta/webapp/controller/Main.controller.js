sap.ui.define([
    ...
    return Controller.extend("mikelazqueta.mikelazqueta.controller.Main", {
        ...
        onInit: function () {
            ...
            this._bus.subscribe("incidence", "borrarIncidencia", function(channelId, eventId, data){
        ...
        onReadODataIncidence: function (empID) {
            this.getView().getModel("incidenceModel").read("/IncidentsSet", {
                filters: [
                    new sap.ui.model.Filter("SapId", "EQ", this.getOwnerComponent().SapId),
                    new sap.ui.model.Filter("EmployeeId", "EQ", empID.toString())
                ],
